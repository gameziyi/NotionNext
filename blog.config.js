...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Mr.C', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'GPTS导航', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://igpts.ai', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'gpts, chatgpt, AI', // 网站关键词 英文逗号隔开
